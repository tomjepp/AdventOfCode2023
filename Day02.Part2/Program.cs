...
internal class Game(int id)
{
    ...
    private int RequiredRed => BallCollections.Max(x => x.Red);
    private int RequiredGreen => BallCollections.Max(x => x.Green);
    private int RequiredBlue => BallCollections.Max(x => x.Blue);
